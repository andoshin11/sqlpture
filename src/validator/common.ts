...
import { BinaryExpression, BinaryOperator, Expression, Identifier, NullLiteral, Statement, UpdateStatement, VariableExpression, BooleanLiteral, StringLiteral, NumericLiteral, LogicalExpression, LogicalOperator } from '../AST'
...
type ValidateBinaryExpression<
  ...
  Left extends Expression = Exp extends BinaryExpression<infer _Left, any, any> ? _Left : never,
  Operator extends BinaryOperator = Exp extends BinaryExpression<any, infer _Operator, any> ? _Operator : never,
  Right extends Expression = Exp extends BinaryExpression<any, any, infer _Right> ? _Right : never,
      ...
      ? L0 extends BinaryExpression
        ? O0 extends LogicalOperator
          ? R0 extends BinaryExpression
            ? ValidateLogicalExpression<ValidateBinaryExpression<DB, Node, L0>, O0, ValidateBinaryExpression<DB, Node, R0>>
            : false
          : false
        : false
      : true
