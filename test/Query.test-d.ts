...
type T35 = Query<fixtures.Q35, fixtures.DB>
const V35: T35 = [{ first_name: 'John', last_name: 'Smith', rental_date: new Date() }]
expectType<T35>(V35)

type T36 = Query<fixtures.Q36, fixtures.DB>
const V36: T36 = [{ first_name: 'John', last_name: 'Smith', rental_date: new Date() }]
expectType<T36>(V36)

type T37 = Query<fixtures.Q37, fixtures.DB>
const V37: T37 = [{ film_id: 1, title: 'Matrix', inventory_id: 10 }]
expectType<T37>(V37)

type T38 = Query<fixtures.Q38, fixtures.DB>
const V38: T38 = [{ first_name: 'John', last_name: 'Smith', rental_date: new Date() }]
expectType<T38>(V38)

type T39 = Query<fixtures.Q39, fixtures.DB>
const V39: T39 = [{ first_name: 'John', last_name: 'Smith', rental_date: new Date() }]
expectType<T39>(V39)


type T200 = Query<fixtures.Q200, fixtures.DB>

type T201 = Query<fixtures.Q201, fixtures.DB>
const V201: T201 = [{ rental_id: 1, rental_date: new Date('2005-05-24 22:53:30'), inventory_id: 367, customer_id: 130, return_date: new Date('2005-05-26 22:04:30'), staff_id: 1, last_update: new Date('2006-02-15 21:30:53') }]
expectType<T201>(V201)
